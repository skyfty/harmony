export async function main(argv: string[]): Promise<void> {
  ...
  switch (command) {
    ...
    case "sync-physics":
      {
        const { cmdSyncPhysics } = await import("./commands/syncPhysics.js");
...
Commands:
  ...
  sync-physics --mode <subpackage-uni-modules> [--repoRoot <path>] [--projectRoot <path>] [--dest <path>] [--subpackageRoot <path>] [--moduleName <name>]
