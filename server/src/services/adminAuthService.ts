...
const ADMIN_PERMISSION_SEEDS = [
  ...
  { code: 'skin:read', name: '皮肤查看', group: 'skin' },
  { code: 'skin:write', name: '皮肤管理', group: 'skin' },
  { code: 'skinCategory:read', name: '皮肤分类查看', group: 'skin' },
  { code: 'skinCategory:write', name: '皮肤分类管理', group: 'skin' },
