...
const BACKEND_MENU_TREE: MenuNode[] = [
  ...
  },
  {
    ...
    component: 'BasicLayout',
    requiredPermissions: ['controllableAsset:read', 'product:read', 'vehicle:read'],
    meta: { icon: 'lucide:gamepad-2', title: '可控对象管理' },
    children: [
      {
        name: 'ControllableAssetsIndex',
        path: '/controllable-assets',
        component: '/views/controllable-assets/index.vue',
        requiredPermissions: ['controllableAsset:read', 'product:read', 'vehicle:read'],
        meta: { icon: 'lucide:gamepad-2', title: '可控对象' },
      },
    ],
  },
  {
