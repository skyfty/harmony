...
const excludedDirectories = new Set([
  ...
  resolve(tourRoot, 'src/pages/physics-cannon'),
]);
...
const sourceFiles = collectSourceFiles(resolve(tourRoot, 'src'));
...
console.log('[harmony-tour] verified mp-weixin main package source boundary');
