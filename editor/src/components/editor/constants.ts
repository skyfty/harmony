...
import { POINT_LIGHT_HELPER_SIZE as POINT_LIGHT_HELPER_SIZE_FROM_UTILS, DIRECTIONAL_LIGHT_HELPER_SIZE as DIRECTIONAL_LIGHT_HELPER_SIZE_FROM_UTILS, LIGHT_HELPER_DEFAULT_COLOR as LIGHT_HELPER_DEFAULT_COLOR_FROM_UTILS, LIGHT_HELPERS_DEBUG as LIGHT_HELPERS_DEBUG_FROM_UTILS } from '@/stores/lightUtils'
export { GROUND_NODE_ID } from '@schema/core'
...
export const POINT_LIGHT_HELPER_SIZE = POINT_LIGHT_HELPER_SIZE_FROM_UTILS
export const DIRECTIONAL_LIGHT_HELPER_SIZE = DIRECTIONAL_LIGHT_HELPER_SIZE_FROM_UTILS
export const LIGHT_HELPER_DEFAULT_COLOR = LIGHT_HELPER_DEFAULT_COLOR_FROM_UTILS
export const LIGHT_HELPERS_DEBUG = LIGHT_HELPERS_DEBUG_FROM_UTILS
