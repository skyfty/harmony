...
export function buildFloorDynamicMeshPresetPatch(
  preset: FloorPresetData | null | undefined,
): Pick<FloorDynamicMesh, 'topBottomMaterialConfigId' | 'sideMaterialConfigId' | 'smooth' | 'thickness' | 'sideUvScale'> | null {
  if (!preset) {
    return null
  }
