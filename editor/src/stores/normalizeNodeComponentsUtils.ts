  ...
  if (node.dynamicMesh?.type === 'Wall') {
    ...
    const nextProps = cloneWallComponentProps(
      clampWallProps({
        ...
        headAssetHeight: (existingProps as { headAssetHeight?: number }).headAssetHeight ?? baseProps.headAssetHeight,
        footAssetId: (existingProps as { footAssetId?: string | null }).footAssetId ?? baseProps.footAssetId,
        footAssetHeight: (existingProps as { footAssetHeight?: number }).footAssetHeight ?? baseProps.footAssetHeight,
        bodyUvAxis: (existingProps as { bodyUvAxis?: 'auto' | 'u' | 'v' }).bodyUvAxis ?? (baseProps as any).bodyUvAxis,
        headUvAxis: (existingProps as { headUvAxis?: 'auto' | 'u' | 'v' }).headUvAxis ?? (baseProps as any).headUvAxis,
        footUvAxis: (existingProps as { footUvAxis?: 'auto' | 'u' | 'v' }).footUvAxis ?? (baseProps as any).footUvAxis,
        bodyEndCapAssetId: (existingProps as { bodyEndCapAssetId?: string | null }).bodyEndCapAssetId ?? baseProps.bodyEndCapAssetId,
        bodyEndCapOffsetLocal: (existingProps as { bodyEndCapOffsetLocal?: unknown }).bodyEndCapOffsetLocal ?? (baseProps as any).bodyEndCapOffsetLocal,
        headEndCapAssetId: (existingProps as { headEndCapAssetId?: string | null }).headEndCapAssetId ?? baseProps.headEndCapAssetId,
        headEndCapOffsetLocal: (existingProps as { headEndCapOffsetLocal?: unknown }).headEndCapOffsetLocal ?? (baseProps as any).headEndCapOffsetLocal,
        footEndCapAssetId: (existingProps as { footEndCapAssetId?: string | null }).footEndCapAssetId ?? baseProps.footEndCapAssetId,
        footEndCapOffsetLocal: (existingProps as { footEndCapOffsetLocal?: unknown }).footEndCapOffsetLocal ?? (baseProps as any).footEndCapOffsetLocal,
        ...
        footOrientation: (existingProps as { footOrientation?: unknown }).footOrientation ?? (baseProps as any).footOrientation,
        ...
        footEndCapOrientation: (existingProps as { footEndCapOrientation?: unknown }).footEndCapOrientation ?? (baseProps as any).footEndCapOrientation,
        cornerModels,
      }),
    )
