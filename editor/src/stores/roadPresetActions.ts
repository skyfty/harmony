...
function parseRoadPresetRoadProps(value: unknown): StrictRoadPresetRoadProps {
  ...
  const widthSafe = clampRoadProps({
    ...
    collisionSubdivisionFactor: raw.collisionSubdivisionFactor as any,
  ...
  return {
    ...
    collisionSubdivisionFactor: widthSafe.collisionSubdivisionFactor ?? 1.0,
  ...
  return {
    ...
    async saveRoadPreset(
      ...
      const roadProps: StrictRoadPresetRoadProps = {
        ...
        collisionSubdivisionFactor: clamped.collisionSubdivisionFactor ?? 1.0,
