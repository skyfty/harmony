...
const PURE_PURSUIT_CRUISE_SPEED_SCALE = 0.95
const PURE_PURSUIT_CURVE_MIN_SPEED_RATIO = 0.32
...
const PURE_PURSUIT_PREVIEW_TURN_FULL_ANGLE = THREE.MathUtils.degToRad(58)
