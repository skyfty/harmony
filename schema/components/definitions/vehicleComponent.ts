...
export const DEFAULT_SUSPENSION_STIFFNESS = 32
export const DEFAULT_DAMPING_RELAXATION = 2.5
export const DEFAULT_DAMPING_COMPRESSION = 4.8
export const DEFAULT_FRICTION_SLIP = 1.6
