...
const PRESETS: ParticlePresetEntry[] = [
  ...
  },
  {
    ...
    props: clampParticleSystemComponentProps({
      ...
      budget: { qualityTier: 'balanced', maxParticles: 72, spawnRateScale: 0.58, cullDistance: 56, updateHz: 24 },
      exposedParams: { ...DEFAULT_PARTICLE_EXPOSED_PARAMS, color: '#f9feff', emissionRate: 10, burstCount: 6, radius: 2.1, speed: 0.2, lifetime: 8.2, particleSize: 0.12, opacity: 0.88 },
      render: { textureAssetId: null, blendMode: 'alpha', depthWrite: false, sortOffset: 0, renderMode: 'sprite' },
      emitters: [
        {
          id: 'snow_field',
