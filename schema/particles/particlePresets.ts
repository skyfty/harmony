...
const PRESETS: ParticlePresetEntry[] = [
  ...
  },
  {
    ...
    props: clampParticleSystemComponentProps({
      ...
      budget: { qualityTier: 'mini-safe', maxParticles: 64, spawnRateScale: 0.62, cullDistance: 42, updateHz: 30 },
      exposedParams: { ...DEFAULT_PARTICLE_EXPOSED_PARAMS, color: '#8ecff2', emissionRate: 12, burstCount: 8, radius: 1.35, speed: 8.8, lifetime: 0.85, particleSize: 0.04, opacity: 0.38 },
      render: { textureAssetId: null, blendMode: 'alpha', depthWrite: false, sortOffset: 0, renderMode: 'sprite' },
      emitters: [
        {
          id: 'rain_field',
  ...
  },
  {
    ...
    props: clampParticleSystemComponentProps({
      ...
      budget: { qualityTier: 'mini-safe', maxParticles: 40, spawnRateScale: 0.5, cullDistance: 34, updateHz: 30 },
      exposedParams: { ...DEFAULT_PARTICLE_EXPOSED_PARAMS, color: '#96d5f4', emissionRate: 7, burstCount: 4, radius: 0.9, speed: 7.5, lifetime: 0.72, particleSize: 0.034, opacity: 0.3 },
      render: { textureAssetId: null, blendMode: 'alpha', depthWrite: false, sortOffset: 0, renderMode: 'sprite' },
      emitters: [
        {
          id: 'rain_field',
  ...
  },
  {
    ...
    props: clampParticleSystemComponentProps({
      ...
      budget: { qualityTier: 'balanced', maxParticles: 96, spawnRateScale: 0.7, cullDistance: 50, updateHz: 30 },
      exposedParams: { ...DEFAULT_PARTICLE_EXPOSED_PARAMS, color: '#7fc6ec', emissionRate: 18, burstCount: 10, radius: 1.6, speed: 10.5, lifetime: 0.86, particleSize: 0.048, opacity: 0.44 },
      render: { textureAssetId: null, blendMode: 'alpha', depthWrite: false, sortOffset: 0, renderMode: 'sprite' },
      emitters: [
        {
          id: 'rain_field',
  ...
  },
  {
    ...
    props: clampParticleSystemComponentProps({
      ...
      budget: { qualityTier: 'mini-safe', maxParticles: 64, spawnRateScale: 0.5, cullDistance: 46, updateHz: 24 },
      exposedParams: { ...DEFAULT_PARTICLE_EXPOSED_PARAMS, color: '#f4fbff', emissionRate: 6, burstCount: 4, radius: 1.4, speed: 0.45, lifetime: 5.2, particleSize: 0.09, opacity: 0.72 },
      render: { textureAssetId: null, blendMode: 'alpha', depthWrite: false, sortOffset: 0, renderMode: 'sprite' },
      emitters: [
        {
          id: 'snow_field',
  ...
  },
  {
    ...
    props: clampParticleSystemComponentProps({
      ...
      budget: { qualityTier: 'mini-safe', maxParticles: 40, spawnRateScale: 0.4, cullDistance: 40, updateHz: 24 },
      exposedParams: { ...DEFAULT_PARTICLE_EXPOSED_PARAMS, color: '#f7fdff', emissionRate: 3, burstCount: 2, radius: 1.2, speed: 0.35, lifetime: 6.2, particleSize: 0.08, opacity: 0.62 },
      render: { textureAssetId: null, blendMode: 'alpha', depthWrite: false, sortOffset: 0, renderMode: 'sprite' },
      emitters: [
        {
          id: 'snow_field',
  ...
  },
  {
    ...
    props: clampParticleSystemComponentProps({
      ...
      budget: { qualityTier: 'balanced', maxParticles: 72, spawnRateScale: 0.65, cullDistance: 54, updateHz: 24 },
      exposedParams: { ...DEFAULT_PARTICLE_EXPOSED_PARAMS, color: '#f8fdff', emissionRate: 10, burstCount: 6, radius: 1.8, speed: 0.75, lifetime: 4.6, particleSize: 0.1, opacity: 0.82 },
      render: { textureAssetId: null, blendMode: 'alpha', depthWrite: false, sortOffset: 0, renderMode: 'sprite' },
      emitters: [
        {
          id: 'snow_field',
